...
public class NewCrimeReportActivity extends AppCompatActivity {
    ...
    String CRIME_URL = "http://192.168.43.241/TechTraffic/CrimeReport.php";
                ...
                if (!LicenseNumber.isEmpty() && !PlateNumber.isEmpty() &&!CrimeSection.isEmpty() && !CrimeType.isEmpty() && !Message.isEmpty()) {
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, CRIME_URL, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (code.equals("Success")) {
                                    finish();
                                    Toast.makeText(NewCrimeReportActivity.this, "Registeration is Successful ", Toast.LENGTH_LONG).show();
                                ...
                                Toast.makeText(NewCrimeReportActivity.this, "Registeration is Successfulio ", Toast.LENGTH_LONG).show();
                                e.printStackTrace();
                            }
                        }
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(NewCrimeReportActivity.this, "Data Base Connection Error", Toast.LENGTH_LONG).show();
                        }
                    }) {
                        @Override
        ...
        builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (code.equals("Driver_is_Not_Found")) {
                    startActivity(new Intent(NewCrimeReportActivity.this, MainActivity.class));
                }
                if (code.equals("crime_before")) {

                    Toast.makeText(NewCrimeReportActivity.this, "Repeated Crimes With this License Number", Toast.LENGTH_LONG).show();
                }
                if (code.equals("Crime_Registeration_Failed")) {
                    Toast.makeText(NewCrimeReportActivity.this, "Crime Registeration Failed", Toast.LENGTH_LONG).show();
                }
    ...
    public void sendOnChannel(View view) {
        String DriverName = DriverName1.getText().toString();
